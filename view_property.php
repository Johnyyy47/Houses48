...
<section class="view-property">
   ...
   <div class="details">
     <div class="swiper images-container">
      ...
      <div class="info">
         <p><i class="fas fa-gbp"></i><span><?= $fetch_property['price']; ?></span></p>
      ...
      <div class="flex">
         <div class="box">
            ...
            <p><i>deposit amount : </i><span><span class="fas fa-gbp" style="margin-right: .5rem;"></span><?= $fetch_property['deposite']; ?></span></p>
